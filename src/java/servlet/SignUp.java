...
public class SignUp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Mail obMail = new Mail();
            ...
            obCompras.setNombre(request.getParameter("nombre"));
            obCompras.setApellido(request.getParameter("apellido"));
            obCompras.setApellidoM(request.getParameter("apellidoM"));
            obCompras.setCorreo(request.getParameter("email"));
            obCompras.setId_departamento(request.getParameter("departamento"));
            obCompras.setId_sucursal(request.getParameter("sucursal"));
