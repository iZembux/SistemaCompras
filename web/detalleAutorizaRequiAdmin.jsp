...
<html>
    ...
    <body>
        ...
        <div class="container my-5">
            <form action="menuAutorizaRequiAdmin.jsp" method="post">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <%                //Consulta por idRequi seleccionada
                        ...
                        arrayRequis = obj.consultarDetalleRequiGerenteAdmin(idRequi);
                        ...
                        <td>
                            <div class="row">
                                <form action="actualizaGerente.jsp" method="post">
                                    ...
                                    <input type="hidden" class="hidden" name="admin" value="1" >
