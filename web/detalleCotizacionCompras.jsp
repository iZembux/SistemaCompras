                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=entrega%> Dias</td>
                                <td><%=anticipo%> %</td>
                                <td><button onClick="document.formulario.action='visor.jsp'; //document.formulario.target='_blank'" value="<%=ruta%>" name="search" class="btn btn-dark btn-sm">Ver PDF</button></td>
                                <td>
