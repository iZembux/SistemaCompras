...
<%
    ...
    if (usuarioValidado == null) {
        ...
        if(usuario.equals("282"))
            status = 7;
        
        if(usuario.equals("294"))
            status = 19;
...
<html>
    <head>
        ...
        <title>Historial de comparativos</title>
    </head>
    <body>
        ...
        <div class="container my-5">
            <div class="page-header">
                <h3>Historial de comparativos</h3>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <%
                        ...
                        arrayRequis = obj.consultarHistorialCuadrosComparativos(status);
