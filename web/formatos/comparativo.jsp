    ...
    <body>
        <div class="container">
            <div class="card mx-auto w-50">
                <h5 class="card-header">Seleccionar Cotizacion</h5>
        ...
        <div class="container">
            <div class="card mx-auto w-80" id="areaImp">
        ...
        <form> 
            <input style="Position:Absolute; left:85%; top:20%; color: #17202A; background-color: #D7DBDD; width:80px; height: 30px; font-size: 12pt;" type="button" onclick="imprimeDiv('areaImp')" value="Imprimir"  class="btn btn-sm"/> 
        </form> 
    </body>
</html>
