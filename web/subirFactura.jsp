...
<%
    ...
    ResultSet rs;
        ...
        File archivo_server = new File("C:/facturasCompras/FAC_"+nombre_archivo_nuevo +"." +  extension);
        Ruta = "C:/facturasCompras/FAC_"+nombre_archivo_nuevo+"." +  extension;
        try {
            if (banderaGeneral == 1) {
            ...
            System.out.println("Ocurrio un error al guardar el archivo" + e);
                ...
                try {
                    if (elemento.equals("Orden")) {
                        idOrden = Integer.parseInt(item.getString());
                    }
                } catch (Exception e) {
                    System.out.println("No recibi valor de elemento int cantidad" + idOrden);
                }
            }
        }

    sql = "UPDATE scompras.ordenes_compra SET rutaFactura = '"+Ruta+"' WHERE idCotizacionOrden = '"+idOrden+"';";
